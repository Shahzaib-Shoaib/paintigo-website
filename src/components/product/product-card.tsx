...
const ProductCard = ({ product }: any) => {
  ...
  return (
    <Link legacyBehavior href={`${ROUTES.PRODUCT}/${handle}`}>
      ...
      <div className="w-full max-w-sm bg-white border border-gray-300 rounded-lg shadow xl:border-gray-200">
        ...
        <div className="px-5 pb-5">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="text-white bg-[#262626] hover:bg-gray-800  font-medium rounded-lg text-sm px-5 py-2.5 text-center">
              Add to cart
            </span>
          </div>
        </div>
