	...
	return (
		...
		>
			...
			>
				<h2
					className={cn(
						"text-sm font-semibold leading-relaxed text-[#262626] pe-2",
						{
				...
				<div className="flex-shrink-0 relative w-4 h-4 flex justify-center items-center">
					<div className="w-full h-0.5 bg-[#262626] rounded-sm" />
					<div
						className={`origin-bottom transform w-0.5 h-full bg-[#262626] rounded-sm absolute bottom-0 transition-transform duration-500 ease-in-out ${
